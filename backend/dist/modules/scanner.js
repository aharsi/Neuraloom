...
export async function scanUrl(url) {
    try {
        ...
        let date = $('meta[name="date"], meta[property="article:published_time"], meta[name="publication_date"]').attr("content") || undefined;
        let author = $('meta[name="author"], meta[property="article:author"], meta[name="byline"]').attr("content") || undefined;
