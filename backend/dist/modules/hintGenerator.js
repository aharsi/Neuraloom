 ...
 */
export async function generateReconstructionHints(scan, apiKey) {
    try {
        const cohere = new CohereClient({ token: apiKey });
        const text = `${scan.title}\n\n${scan.content.substring(0, 4000)}`; // safe length
...
`;
        ...
        return {
            summaryHint: scan.content.substring(0, 400).trim() + "...",
            keywords: [],
        };
    }
}
//# sourceMappingURL=hintGenerator.js.map